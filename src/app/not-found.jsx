...
export default function NotFound() {
  ...
  return (
    <Box 
      className="tw-min-h-screen tw-flex tw-items-center tw-justify-center tw-relative tw-overflow-hidden"
      sx={{
    ...
    >
      ...
      <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1 }}>
        <Paper 
          elevation={24}
          className="tw-p-12 tw-text-center tw-rounded-3xl tw-backdrop-blur-lg"
          sx={{
        ...
        >
          ...
          <Typography 
            variant="body1"
            className="tw-mb-8 tw-text-gray-700 tw-max-w-lg tw-mx-auto"
            sx={{
          ...
          >
            ...
            It might have been abducted by aliens or lost in a black hole. 
            Let's navigate you back to safety! 🛸
          </Typography>

          {/* Buttons */}
          <Box 
            className="tw-flex tw-gap-4 tw-justify-center tw-flex-wrap"
            sx={{
          ...
          {/* Error Code */}
          <Box 
            className="tw-mt-10 tw-pt-8 tw-border-t tw-border-gray-200"
            sx={{
          ...
          >
            ...
            {/* Fun Stats */}
            <Box className="tw-flex tw-gap-6 tw-justify-center tw-mt-4 tw-flex-wrap">
              <Box>
